...
public repository. The full training traces, optimizer-update ledgers, actor and training
checkpoints, shared calibration metadata, induced rule banks, and fitted-critic checkpoints
(584 files, 4.7\,GB uncompressed) are deposited as an archival dataset at
\cite{liu2026auditablerl}. The dataset archive is accompanied by a SHA-256 checksum file
