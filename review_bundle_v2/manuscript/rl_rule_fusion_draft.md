...
> Draft status: this manuscript body predates the eight-seed shared-symbolizer study and the 2026-09-22 follow-up diagnostics. It does not yet include Experiment B, the Acrobot arbitration/random-action controls, or the FQE-GPI quality checks. Use the current evidence summary in `README.md` and `paper/20260922_RL_Grammar_Fusion_Research_Report.md`; reconcile this draft before submission.
...
- `auditability/merge_seed_grammars.py`
- `auditability/compare_seed_grammars.py`
- `auditability/analyze_trace_mdl_by_round.py`
- `runs/grammar_merge_070_final/merge_evaluation.json`
- `runs/grammar_merge_070_final/merged_policy_trace.jsonl`
- `runs/grammar_merge_090_final/merge_evaluation.json`
- `runs/grammar_intersections/`
- `runs/grammar_mdl_seed11_070.json`
- `runs/repeatability_full/`
- `runs/replication_summary.json`
